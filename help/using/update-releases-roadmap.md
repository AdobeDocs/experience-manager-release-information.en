...
| Release |Event |Schedule |Status |
|---|---|---|---|
| Maintenance Release [X](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/release-notes/maintenance/latest)|Automatic Update|July 14-16, 2025|Target|

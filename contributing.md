...
Thank you for choosing to contribute to Adobe Experience Manager documentation! Content contributions are welcomed from the entire reader community and from fellow Adobe employees.

This article describes how you can contribute and points out the guidelines to follow when making your contributions.
...
While any contributions are welcomed to improve AEM documentation, contributions must adhere to certain guidelines and standards where possible. Review the [Guidelines for Contributing to AEM Documentation](guidelines.md) for more information.
...
Issues let you easily describe your idea for improvement to the docs and an AEM Docs Team member can review it. Simply click the **Log an issue** link at the top of the right navigation panel on any page so you can create an issue.

### Create a Pull Request {#create-a-pull-request}

If you see a problem and know exactly how to fix it, consider creating a pull request. Pull requests allow you to make your own edits to the documentation, which are then reviewed for inclusion by an AEM Docs Team member. Simply click **Edit this page** link at the top of the right navigation panel on any page so you can make your suggested changes and create the pull request.

All pull requests must be accompanied by a signed [contributor license agreement or CLA](https://opensource.adobe.com/cla.html). This gives Adobe permission to redistribute your contributions as part of the project. You only submit an Adobe CLA one time, so if you have submitted one previously, you are good to go!
...
Any contribution is welcomed and reviewed if it is made on the public repository. However, pull requests from Adobe employees are easier to process and faster to approve on the corporate repo. Make sure that any proprietary information is only discussed on the corporate repo.
